...
<head>
    ...
    <script type="text/javascript">
        ...
        function initBlogList(pageIndex) {
            $.getJSON("../control/blog", "opr=allBlogList&keyword=" + $("#keyword").val() + "&pageIndex=" + pageIndex, processBlogsList);
        }
...
<div id="main">
    ...
    <div id="mainBanner">
        ...
        <div id="mainBannerTitle">
            ...
            <div id="mainBannerTitleWord"><b>首页</b>&nbsp;&nbsp;&nbsp;&nbsp;<a href="home_pop.jsp"><b>热门</b></a>
            </div>
        ...
        <div id="mainRight1">
            ...
            <div id="mainRightPostionSecondLine">
                ...
                <div id="mainRightPositionSecondLineContent">
                    <a href="../pages/home.jsp" class="a1"><span class="style3">首页</span></a>
                    <hr class="h1">
