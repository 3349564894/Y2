...
<div class="action divaction">
    ...
    <div class="pages">
        <!--员工信息区域 开始-->
        <form action="<%=request.getContextPath() %>/control/employee?opr=addNew" enctype="multipart/form-data"
            ...
            <table class="leave">
                <tr>
                    ...
                    <td class="width2"><input type="text" id="employeeNo" name="employeeNo"/></td>
                </tr>
                <tr>
